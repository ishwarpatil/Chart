...
let getSymbol = () => {
  ...
  //let url = ;
  d3.json('http://db.accrue.com/api/data/history?auth-token=Sy1zihufJ2cOeLMSKrkKsvZF_QRjS4XWG2rg4dO7veM&symbol=' + symbol + '&type=daily', function (data) {
    ...
    smbl.forEach(function (d) {
      d.dd = new Date(d.time);
